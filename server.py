...
def initialize_db():
    ...
    cur.execute("""INSERT INTO products (name, imgpath, price, stock) VALUES \
        ('Nike shoes', 'images/nike-shoes.png', 20000, 8), \
        ('iPhone', 'images/iphone.png', 100000, 2), \
        ('Succulent', 'images/succulent.png', 3500, 34), \
        ('Office chair', 'images/chair.png', 32500, 0), \
        ('Smart watch', 'images/watch.png', 57900, 29)
    """)
...
def home_page():
    ...
    earnings = result/100.0 if result else 0.00
